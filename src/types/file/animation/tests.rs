use crate::{
    ...
    types::{Animation, ForceReply, InputFile, ParseMode, SendAnimation, TextEntity},
};

#[test]
fn animation_deserialize_full() {
...
#[test]
fn animation_deserialize_partial() {
    let data: Animation = serde_json::from_value(serde_json::json!({
        "file_id": "AwADBAADbXXXXXXXXXXXGBdhD2l6_XX",
        "file_unique_id": "unique-id",
        "width": 200,
