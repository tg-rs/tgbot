...
impl InputMessageContentInvoice {
    ...
    /// # Arguments
    ///
    /// * value - Whether the final price depends on the shipping method
    ...
    /// # Arguments
    ///
    /// * value - Whether email address of a user is required to complete the order
    ...
    /// # Arguments
    ///
    /// * value - Whether full name of a user is required to complete the order
    ...
    /// # Arguments
    ///
    /// * value - Whether phone number of a user is required to complete the order
    ...
    /// # Arguments
    ///
    /// * value - Whether shipping address of a user is required to complete the order
    ...
    /// # Arguments
    ///
    /// * value - Whether email address of a user should be sent to provider
    ...
    /// # Arguments
    ///
    /// * value - Whether phone number of a user should be sent to provider
